 ...
 * @author Usuario
 */
public class RegistroEspectador extends javax.swing.JDialog {

    /**
     * Creates new form RegistroEspectador
     */
    public RegistroEspectador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REGISTRO DE ESPECTADOR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroEspectador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RegistroEspectador dialog = new RegistroEspectador(new javax.swing.JFrame(), true);
